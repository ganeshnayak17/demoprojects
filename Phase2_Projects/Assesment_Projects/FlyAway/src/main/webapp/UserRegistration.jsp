...
<body>
	<br>
	<a href="Homepage.jsp"
		style="color: black; text-decoration: none; font-size: 35px; fontweight: bold;">FlyAway</a>
	<br>
	<br>
	<center>
		<div
			...
			<form action="UserRegistration" method="post">
				<label for="email">Email :-</label> <input type="email" name="email"
					id="email" /><br>
				<br> <label for="pass">Password :-</label> <input
				...
				<br> <label for="adno">Aadhaar No. :-</label> <input
					type="text" name="adno" id="adno" /><br>
